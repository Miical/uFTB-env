...
import mlvp
from mlvp import delay_assign, delay_func
...
class BPUTop:
    def __init__(self, dut, pipeline_ctrl):
        ...
        self.update = UpdateBundle.from_prefix(uFTB, "io_update_")
        self.out = BranchPredictionResp.from_prefix(uFTB, "io_out_")
...
async def uftb_test():
    ...
    mlvp.create_task(BPUTop(uFTB, PipelineCtrlBundle()).run())
